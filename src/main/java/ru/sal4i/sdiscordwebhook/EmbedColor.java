 ...
 * When constructing a {@code EmbedColor} with an explicit alpha or
 * getting the color/alpha components of a {@code EmbedColor}, the color
...
public class EmbedColor implements Paint, java.io.Serializable {
     ...
     * @since 1.4
     */
    public static final EmbedColor WHITE = white;

    /**
     * The color light gray.  In the default sRGB space.
     */
    public static final EmbedColor lightGray = new EmbedColor(192, 192, 192);
     ...
     * @since 1.4
     */
    public static final EmbedColor LIGHT_GRAY = lightGray;

    /**
     * The color gray.  In the default sRGB space.
     */
    public static final EmbedColor gray = new EmbedColor(128, 128, 128);
     ...
     * @since 1.4
     */
    public static final EmbedColor GRAY = gray;

    /**
     * The color dark gray.  In the default sRGB space.
     */
    public static final EmbedColor darkGray = new EmbedColor(64, 64, 64);
     ...
     * @since 1.4
     */
    public static final EmbedColor DARK_GRAY = darkGray;
     ...
     * @since 1.4
     */
    public static final EmbedColor BLACK = black;

    /**
     * The color red.  In the default sRGB space.
     */
    public static final EmbedColor red = new EmbedColor(255, 0, 0);
     ...
     * @since 1.4
     */
    public static final EmbedColor RED = red;

    /**
     * The color pink.  In the default sRGB space.
     */
    public static final EmbedColor pink = new EmbedColor(255, 175, 175);
     ...
     * @since 1.4
     */
    public static final EmbedColor PINK = pink;

    /**
     * The color orange.  In the default sRGB space.
     */
    public static final EmbedColor orange = new EmbedColor(255, 200, 0);
     ...
     * @since 1.4
     */
    public static final EmbedColor ORANGE = orange;

    /**
     * The color yellow.  In the default sRGB space.
     */
    public static final EmbedColor yellow = new EmbedColor(255, 255, 0);
     ...
     * @since 1.4
     */
    public static final EmbedColor YELLOW = yellow;

    /**
     * The color green.  In the default sRGB space.
     */
    public static final EmbedColor green = new EmbedColor(0, 255, 0);
     ...
     * @since 1.4
     */
    public static final EmbedColor GREEN = green;

    /**
     * The color magenta.  In the default sRGB space.
     */
    public static final EmbedColor magenta = new EmbedColor(255, 0, 255);
     ...
     * @since 1.4
     */
    public static final EmbedColor MAGENTA = magenta;

    /**
     * The color cyan.  In the default sRGB space.
     */
    public static final EmbedColor cyan = new EmbedColor(0, 255, 255);
     ...
     * @since 1.4
     */
    public static final EmbedColor CYAN = cyan;

    /**
     * The color blue.  In the default sRGB space.
     */
    public static final EmbedColor blue = new EmbedColor(0, 0, 255);
     ...
     * @since 1.4
     */
    public static final EmbedColor BLUE = blue;
    /*
...
//    }
    ...
    public EmbedColor(int r, int g, int b, int a) {
        value = ((a & 0xFF) << 24) |
                ((r & 0xFF) << 16) |
                ((g & 0xFF) << 8) |
//                ((b & 0xFF) << 0);
     ...
     * @see #getRGB
     */
    public EmbedColor(int rgba, boolean hasalpha) {
        if (hasalpha) {
            value = rgba;
        } else {
     ...
     * @see #getRGB
     */
    public EmbedColor(float r, float g, float b) {
     ...
     * @see #getRGB
     */
    public EmbedColor(float r, float g, float b, float a) {
     ...
     * @see #getColorComponents
     */
    public EmbedColor(ColorSpace cspace, float[] components, float alpha) {
        ...
        if (rangeError) {
            throw new IllegalArgumentException(
                    "EmbedColor parameter outside of expected range: " +
                            badComponentString);
        }
    ...
    private static void testColorValueRange(int r, int g, int b, int a) {
        ...
        if (rangeError == true) {
            throw new IllegalArgumentException("EmbedColor parameter outside of expected range:"
                    + badComponentString);
        }
    }
     ...
     * specified opaque {@code EmbedColor}. This method handles string
     * formats that are used to represent octal and hexadecimal numbers.
     *
     * @param nm a {@code String} that represents
     *           an opaque color as a 24-bit integer
     * @return the new {@code EmbedColor} object.
     ...
     * @since 1.1
     */
    public static EmbedColor decode(String nm) throws NumberFormatException {
        Integer intval = Integer.decode(nm);
        int i = intval.intValue();
        return new EmbedColor((i >> 16) & 0xFF, (i >> 8) & 0xFF, i & 0xFF);
    }
     ...
     * as an integer which is then converted to a {@code EmbedColor}
     * object.
     * <p>
     ...
     * @return the {@code EmbedColor} converted from the system
     * property.
     * @see java.lang.System#getProperty(java.lang.String)
     * @see java.lang.Integer#getInteger(java.lang.String)
     * //     * @see EmbedColor#Color(int)
     * @since 1.0
     */
    public static EmbedColor getColor(String nm) {
     ...
     * an integer then the {@code EmbedColor} specified by the second
     * argument is returned instead.
     *
     * @param nm the name of the color property
     * @param v  the default {@code EmbedColor}
     * @return the {@code EmbedColor} converted from the system
     * property, or the specified {@code EmbedColor}.
     * @see java.lang.System#getProperty(java.lang.String)
     * @see java.lang.Integer#getInteger(java.lang.String)
     * //     * @see EmbedColor#Color(int)
     * @since 1.0
     */
    public static EmbedColor getColor(String nm, EmbedColor v) {
     ...
     * and is converted to a {@code EmbedColor} object.
     *
     * @param nm the name of the color property
     * @param v  the default color value, as an integer
     * @return the {@code EmbedColor} converted from the system
     * property or the {@code EmbedColor} converted from
     ...
     * @since 1.0
     */
    public static EmbedColor getColor(String nm, int v) {
        Integer intval = Integer.getInteger(nm);
        int i = (intval != null) ? intval.intValue() : v;
        return new EmbedColor((i >> 16) & 0xFF, (i >> 8) & 0xFF, (i >> 0) & 0xFF);
    }
     ...
     * {@code EmbedColor} constructor that takes a single integer argument.
     *
    ...
    /**
     * Creates a {@code EmbedColor} object based on the specified values
     ...
     * @return a {@code EmbedColor} object with the specified hue,
     * saturation, and brightness.
     * @since 1.0
     */
    public static EmbedColor getHSBColor(float h, float s, float b) {
        return new EmbedColor(HSBtoRGB(h, s, b));
    }
    ...
    /**
     * Creates a new {@code EmbedColor} that is a brighter version of this
     * {@code EmbedColor}.
     * <p>
     * This method applies an arbitrary scale factor to each of the three RGB
     * components of this {@code EmbedColor} to create a brighter version
     * of this {@code EmbedColor}.
     ...
     *
     * @return a new {@code EmbedColor} object that is
     * a brighter version of this {@code EmbedColor}
     * with the same {@code alpha} value.
     * @see EmbedColor#darker
     * @since 1.0
     */
    public EmbedColor brighter() {
        int r = getRed();
        int g = getGreen();
        int b = getBlue();
        int alpha = getAlpha();
        ...
        if (r == 0 && g == 0 && b == 0) {
            return new EmbedColor(i, i, i, alpha);
        }
        if (r > 0 && r < i) r = i;
        if (g > 0 && g < i) g = i;
        if (b > 0 && b < i) b = i;

        return new EmbedColor(Math.min((int) (r / FACTOR), 255),
    ...
    /**
     * Creates a new {@code EmbedColor} that is a darker version of this
     * {@code EmbedColor}.
     * <p>
     * This method applies an arbitrary scale factor to each of the three RGB
     * components of this {@code EmbedColor} to create a darker version of
     * this {@code EmbedColor}.
     * The {@code alpha} value is preserved.
     * Although {@code brighter} and
     ...
     *
     * @return a new {@code EmbedColor} object that is
     * a darker version of this {@code EmbedColor}
     * with the same {@code alpha} value.
     * @see EmbedColor#brighter
     * @since 1.0
     */
    public EmbedColor darker() {
        return new EmbedColor(Math.max((int) (getRed() * FACTOR), 0),
    ...
    /**
     * Computes the hash code for this {@code EmbedColor}.
     *
     ...
     * {@code null} and is a {@code EmbedColor} object that has the same
    ...
    public boolean equals(Object obj) {
        return obj instanceof EmbedColor && ((EmbedColor) obj).getRGB() == this.getRGB();
    }

    /**
     * Returns a string representation of this {@code EmbedColor}. This
     * method is intended to be used only for debugging purposes.  The
     * content and format of the returned string might vary between
     * implementations. The returned string might be empty but cannot
     * be {@code null}.
     *
     * @return a string representation of this {@code EmbedColor}.
     */
     ...
     * components of the {@code EmbedColor}, as represented in the default
     * sRGB color space.
     ...
     * components of the {@code EmbedColor}, in the default sRGB color
    ...
    /**
     * Returns a {@code float} array containing the color and alpha
     * components of the {@code EmbedColor}, in the
     * {@code ColorSpace} of the {@code EmbedColor}.
     ...
     *                  alpha components of this {@code EmbedColor} in its
     ...
     *                  components of this {@code EmbedColor} in its
     *                  {@code ColorSpace} and returns
     ...
     *                  color and alpha components of this {@code EmbedColor} in
     ...
     * @param cspace    a specified {@code ColorSpace}
     * @param compArray an array that this method fills with the color
     *                  components of this {@code EmbedColor} in the specified
     *                  {@code ColorSpace}
     * @return the color components in a {@code float} array.
     */
    ...
    /**
     * Returns the {@code ColorSpace} of this {@code EmbedColor}.
     *
     * @return this {@code EmbedColor} object's {@code ColorSpace}.
     */
...
//        return new java.awt.ColorPaintContext(getRGB(), cm);
     ...
     *
     * @return this {@code EmbedColor} object's transparency mode.
     * @see Paint
     * @see Transparency
     * @see #createContext
     */
